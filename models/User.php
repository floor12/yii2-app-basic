...
class User extends \yii\db\ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            [['fullname', 'auth_key', 'password_hash', 'email', 'phone', 'created', 'updated'], 'required'],
            ...
            [['email'], 'unique'],
            [['phone'], 'unique'],
            ['status', 'default', 'value' => BaseStatus::STATUS_ACTIVE],
            ['status', 'in', 'range' => [BaseStatus::STATUS_ACTIVE, BaseStatus::STATUS_DISABLED]],
    ...
    {
        return static::findOne(['id' => $id, 'status' => BaseStatus::STATUS_ACTIVE]);
    }
